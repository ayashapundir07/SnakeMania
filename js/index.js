...
let inputDir = { x: 0, y: 0 }; //snake to be static
...
function gameEngine() {
  ...
  //if snake has eaten the food increment score and regeenrate food
...
window.requestAnimationFrame(main); //screen frame changes after every activity
